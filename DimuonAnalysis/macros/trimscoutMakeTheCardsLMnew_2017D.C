...
void trimscoutMakeTheCardsLMnew_2017D(string treepath = "scout_2.root", const char* outfilename = "./scoutData4MuonsM70.root", bool isMC=false) {
...
'L1_DoubleMu0_SQ'
	*/
	...
	if(!( l1Result->at(0) || l1Result->at(4) || l1Result->at(10) || l1Result->at(11) || l1Result->at(11) || l1Result->at(15) || l1Result->at(16) )) continue;
