...
void trimscoutMakeTheCardsLMnew_2018C_OptSel(string treepath = "scout_2.root", const char* outfilename = "./scoutData4MuonsM70.root", bool isMC=false) {
...
TH1D* mass_OptIso[10];
    TH1D* mass_OptVtxAbsDist[10];
    TH1D* mass_OptVtxRelDist[10];
    TH1D* mass_OptVtxChi[10];*/
